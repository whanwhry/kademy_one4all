...
public class FoodBill extends Bill{ //เป็นลูกของ class Bill ทำให้สามารถเรียกใช้ method และ constructor ของคลาสพ่อได้
    ...
    public FoodBill(CustomerBill cust, double price) {
    ...
    public String toString() {
        return "Food Bill, "+super.toString();//เรียก toString คลาสพ่อมาใช้ด้วย
    }
